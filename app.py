...
class CardParser:
    ...
    def parse_physical_layer(self, line):
        pass  # Not required, as physical layers are already handled in `parse_architecture`
    ...
    def parse_relay(self, line):
        ...
        if match:
            ...
            if layer_type == "L":  # Logical layer relay
                subunit_id = int(re.sub(r"[^0-9]", "", subunit_or_layer))  # Extract numeric part of "S1", etc.
            ...
            elif layer_type == "P":  # Physical layer relay
                loop_id = int(re.sub(r"[^0-9]", "", subunit_or_layer))  # Extract numeric part of "L0", etc.
